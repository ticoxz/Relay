...
Requires `relay-mcp` on PATH (`npm i -g @ticoxz/relay`).
...
90 days after `@ticoxz/relay@1.3.0` publish: if MCP/JSON are unused, defer new MCP features and focus on readers, `relay doctor`, and HANDOFF.md workflow. See [doc.md](../doc.md) §8.
